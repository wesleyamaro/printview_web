            ...
            <div class="w-full md:w-11/12 mx-auto sm:px-2 lg:p-3 bg-white dark:bg-slate-800 rounded-lg">
                ...
                <div class="md:flex md:items-end md:space-x-5 space-y-3 bg-slate-300 dark:bg-slate-900 p-2 rounded-lg">
                    ...
                    <div class="w-full md:w-3/12">                        
                        <x-select autocomplete="off" z-index="z-50" label="Encontre o usuário que deseja atribuir permissão" placeholder="Selecione um usuário"
                    ...
                    <div>
                        <x-checkbox-wire wire:click="insertRegrasPadrao" wire:model="checkboxPadrao"  positive id="right-label" label="LIBERAR PERMISSÕES PADRÃO ( CLIENTE )" />
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-100 even:dark:bg-gray-800 bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-orange-950">
                                            ...
                                            <td class="flex items-center px-2 py-4">                       
                                                <a wire:click="removeRegraUser({{ $associadas->id }})" wire:key="{{ $associadas->id }}" class="font-medium text-red-600 dark:text-red-500 hover:underline ms-3 cursor-pointer">Remover</a>
                                            </td>
                                        </tr>
