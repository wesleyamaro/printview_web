      ...
      <div class="flex flex-col space-y-3 mb-3">
          ...
          <div
              ...
              <div class="w-full rounded-md ">
                  <x-input-wire wire:model="marca" label="Marca*" placeholder="****" class="dark:text-blue-500" />
              </div>
              ...
              <div class="w-full rounded-md ">
                  {{-- <x-input-wire wire:model="grade" label="Grade:*" placeholder="****" class="dark:text-blue-500" /> --}}
                  <x-textarea-wire label="Grade*" wire:model="grade" rows="4"
                      class="max-h-20 overflow-y-auto soft-scrollbar block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-blue-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      placeholder="Grade do pedido..." />
              </div>
              ...
              @can('EDIT-STATUS-PEDIDO', $permissao)
                  <div class="flex items-end gap-x-2 w-full mt-5">
                      <x-select autocomplete="off" clearable="false" label="Status do  pedido"
                          wire:model.live="statuspedido" placeholder="Selecione o status" :options="['Aberto', 'cadastrado', 'Cancelado']"
                          class="text-blue-500" />
              ...
              <div
                  ...
                  <div class="overflow-y-auto soft-scrollbar max-h-7">
                      <h1 class="text-orange-600 dark:text-orange-400 text-sm md:text-base"> {{ $motivo_cancelamento }}
                      </h1>
                  </div>
              </div>
          ...
          <div class="w-full">
              <x-textarea-wire label="Observações" wire:model="observacao" rows="4"
                  class="max-h-20 overflow-y-auto soft-scrollbar block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-blue-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          {{-- <button class="text-white bg-blue-700" wire:click="generatePdf({{ $idpedido }})"
