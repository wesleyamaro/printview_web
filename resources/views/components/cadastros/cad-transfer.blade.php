<form wire:submit.prevent="salvarProdutos" class="max-w-full  p-1 mx-auto rounded-lg bg-white dark:bg-slate-700">
    ...
    <div class="w-full py-1 md:flex items-center sticky top-0 justify-between  gap-x-2  bg-gray-300 dark:bg-gray-800 rounded-lg px-3">
        ...
        <div class="md:flex items-baseline gap-x-2">
            ...
            <div class="w-52 ">
                <x-select label="Gênero*" placeholder="Selecione o gênero..." wire:model="genero" class="uppercase">
            ...
            <div class="w-52 ">
                <x-select label="Tipo*" placeholder="Selecione o tipo..." wire:model.live="tipo" class="uppercase">
        ...
        <div class="md:w-96">
            <form class="">
                <label for="file-input" class="{{-- sr-only --}} dark:text-gray-400 text-sm">Adicione imagens. ( Limite de 50 imagens por vez ).</label>
                ...
                <div
                    ...
                    <div class="w-full h-52 flex justify-between flex-col px-3">
                        ...
                        <div class="w-full text-left">
                            ...
                            <x-native-select min-items-for-search="5" label="Filtro 1 * ( obrigatório )" wire:model="filtro1.{{$index}}" class="soft-scrollbar uppercase">
                        ...
                        <div class="w-full text-left mb-2 {{ $tipo === 'transfer' ? 'hidden' : '' }}">
                            <x-input-wire wire:model="medida.{{$index}}" label="Medidas ( opcional )" placeholder="Medidas" />
                        </div>
