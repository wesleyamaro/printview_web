...
<div class=" lg:hidden fixed bottom-0 left-0  w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
        ...
        <div class="grid h-full max-w-lg grid-cols-2 mx-auto flex justify-between font-medium">
        @elsecan('MENU-NOVIDADE', $permissao)
            <div class="grid h-full max-w-lg grid-cols-5 mx-auto flex justify-between font-medium">
        @endcan --}}
        <div class="grid h-full max-w-lg grid-cols-5 mx-auto justify-between font-medium">
        
        @can('MENU-NOVIDADE', $permissao)
        <a href="{{ route('novidades') }}"  wire:navigate type="button" class="inline-flex flex-col items-center justify-center px-5 border-gray-200 border-x hover:bg-gray-50 dark:hover:bg-gray-800 group dark:border-gray-600">
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Início
                {{-- <span class="animate-ping absolute inline-flex ml-1 w-2 h-2 rounded-full bg-orange-400 opacity-75"></span> --}}
            </span>
        </a>
        @endcan

        @can('MENU-MAIS-VENDIDO', $permissao)
        <a href="{{ route('mais_vendido') }}"  wire:navigate type="button" class="inline-flex flex-col items-center justify-center px-3 border-gray-200 border-x hover:bg-gray-50 dark:hover:bg-gray-800 group dark:border-gray-600">
        ...
        @can('SUBMENU-TRANSFER', $permissao)
            <a href="{{ route('produtos', ['tipo' => 'transfer']) }}"  wire:navigate type="button" class="inline-flex flex-col items-center justify-center px-3 border-e border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 group dark:border-gray-600">
        ...
        @cannot('PREFEITURA', $permissao)
            ...
            <a href="{{ route('carrinho_compra') }}"  wire:navigate type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            ...
            <a href="{{ route('pedidos') }}"  wire:navigate type="button" class="inline-flex flex-col items-center justify-center px-5 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 group border-x dark:border-gray-600">
        ...
        @can('PREFEITURA', $permissao)
        <a href="{{ route('carrinho_compra') }}"  wire:navigate type="button" class="col-span-2 inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
        ...
        <a href="{{ route('pedidos') }}"  wire:navigate type="button" class="col-span-2 inline-flex flex-col items-center justify-center px-5 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 group {{-- border-x dark:border-gray-600 --}}">
            <svg class="w-5 h-5 mb-2 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
                <path d="M19.9 6.58c0-.009 0-.019-.006-.027l-2-4A1 1 0 0 0 17 2h-4a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v9a1 1 0 0 0 1 1h.3c-.03.165-.047.332-.051.5a3.25 3.25 0 1 0 6.5 0A3.173 3.173 0 0 0 7.7 12h4.6c-.03.165-.047.332-.051.5a3.25 3.25 0 1 0 6.5 0 3.177 3.177 0 0 0-.049-.5h.3a1 1 0 0 0 1-1V7a.99.99 0 0 0-.1-.42ZM16.382 4l1 2H13V4h3.382ZM4.5 13.75a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5Zm11 0a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5Z"/>
              </svg>
            <span class="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Pedidos</span>
