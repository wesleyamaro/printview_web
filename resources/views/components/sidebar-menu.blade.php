 ...
 <div id="drawer-navigation" class="fixed top-0 left-0 z-40 w-72 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
  ...
  <div class="py-4 overflow-y-auto">
      ...
      <a href="{{ route('novidades') }}" wire:navigate class="flex items-center ps-2.5 mb-5">
      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
            <a href="{{ route('mais_vendido') }}" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="{{ route('novidades') }}" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="inline-flex items-center justify-center px-2 py-1 ms-3 text-xs font-medium text-white bg-green-600 rounded-full {{-- dark:bg-gray-700 --}} dark:text-gray-300">New</span>
            </a>
         </li>
         @endcan
         ...
         <li>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                 {{--  @can('SUBMENU-TRANSFER', $permissao)
                  <li>
                     <a href="{{ route('produto_transfer') }}" wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Transfers</a>
                  </li>
                  @endcan
                  @can('SUBMENU-TERMOPATCH', $permissao)
                  <li>
                     <a href="{{ route('produto_termopatch') }}" wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Termopatch</a>
                  </li>
                  @endcan
                  @can('SUBMENU-SINTETICO', $permissao)
                  <li>
                  ...
                  @can('SUBMENU-TRANSFER', $permissao)
                  <li>
                     <a href="{{ route('produtos', ['tipo' => 'transfer']) }}" wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Transfers</a>
                  </li>
                  @endcan
                  @can('SUBMENU-TERMOPATCH', $permissao)
                  <li>
                     <a href="{{ route('produtos', ['tipo' => 'termopatch']) }}" wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Termopatch</a>
                  </li>
                  @endcan
                  @can('SUBMENU-SINTETICO', $permissao)
                  <li>
         ...
         <li>
            <a href="{{ route('carrinho_compra') }}" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="{{ route('pedidos') }}" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            ...
            <ul id="dropdown-gerenciar" class="hidden py-2 space-y-2">
                 ...
                 @can('SUBMENU-TOP-CLIENTE', $permissao)
                  <li>
                    <a href="{{ route('top_cliente') }}"  wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Top Clientes</a>
                 </li>
                 @endcan
                 
                  @can('SUBMENU-LIBERAR-MARCA', $permissao)
                  <li>
                     <a href="{{ route('liberar_marca') }}" wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Liberar marca</a>
                  </li>
                  @endcan

                  @can('SUBMENU-BLOQUEAR-PRODUTO', $permissao)
                  <li>
                     <a href="{{ route('bloquear_referencia') }}"  wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Bloquear produto</a>
                  </li>
                  @endcan
                 
                  @can('SUBMENU-LIBERAR-CLIENTE', $permissao)
                  <li>
                     <a href="{{ route('liberar_cliente') }}" wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Liberar cliente</a>
                  </li>
                  @endcan
                  
                  @can('SUBMENU-LIBERAR-SISTEMA', $permissao)
                 <li>
                    <a href="{{ route('permissao_sistema') }}" wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Permissão sistema</a>
                 </li>
                 @endcan
                 ...
                 <li>
                    <a href="{{ route('registrar_user') }}" wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Registrar usuário</a>
                 </li>
                 @endcan

                 @can('LIST-USER', $permissao)
                 <li>
                    <a href="{{ route('list_user') }}" wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Lista de usuário</a>
                 </li>
                 @endcan
                 ...
                 <li>
                    <a href="{{ route('logs_user') }}" wire:navigate class="flex items-center w-full p-2 text-yellow-600 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-yellow-400 dark:hover:bg-yellow-700">Logs usuário</a>
                 </li>
                 @endcan
                 
                 @can('SUBMENU-PERMISSAO-SISTEMA', $permissao)
                 <li>
                    <a href="{{ route('permissao_sistema') }}" wire:navigate class="flex items-center w-full p-2 text-red-600 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-red-400 dark:hover:bg-red-700">Permissão sistema</a>
                 </li>
                 @endcan

                 @can('PAGAMENTO', $permissao)
                 <li>
                    <a href="{{ route('pagamentos') }}" wire:navigate class="flex items-center w-full p-2 text-yellow-600 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-cyan-400 dark:hover:bg-yellow-700">Pagamentos</a>
                 </li>
                 @endcan
            </ul>
         </li>
         ...
         <li>
            <a href="{{ route('profile.show') }}" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            ...
            <form method="POST" action="{{ route('logout') }}" x-data>
               ...
               <a href="{{ route('logout') }}" @click.prevent="$root.submit();" class="flex items-center p-2 text-red-500 rounded-lg dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-700 group">
   ...
   <div class="mt-60">
      <x-responsive-nav-link id="theme-toggle2" type="button" class="cursor-pointer flex">
