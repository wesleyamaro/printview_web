...
<?php $component = WireUi\View\Components\Select::resolve(['label' => 'Encontre o usuário que deseja liberar a marca','placeholder' => 'Selecione um usuário','emptyMessage' => 'Cliente não encontrado'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['z-index' => 'z-50','wire:model.live' => 'selectedUser']); ?>
...
<?php endif; ?>
                        <!--div table -->
                        <div class="mt-2 max-h-96 md:max-h-50v relative  overflow-y-auto soft-scrollbar shadow-md sm:rounded-lg">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $marcasNaoAssociadasAoUsuario; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $naoassociadas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">                                          
                                            ...
                                            <th scope="row" class="px-1 py-4 font-medium text-xs md:text-sm text-center md:text-start text-gray-900 whitespace-nowrap dark:text-white">
                                                <?php echo e(str_pad($naoassociadas->referencia, 4, '0', STR_PAD_LEFT)); ?>
                                            ...
                                            <td scope="row" class="px-2 py-4 font-medium text-center text-xs md:text-sm uppercase text-gray-900 whitespace-nowrap dark:text-white">
                                                <!--[if BLOCK]><![endif]--><?php switch($naoassociadas->isCliente):
                                                    case (0): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'searchAssociados','placeholder' => 'pesquise a marca...']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf2cba1c7f87bbadef8ee9a6866b4816e)): ?>
<?php $attributes = $__attributesOriginalf2cba1c7f87bbadef8ee9a6866b4816e; ?>
...
<?php endif; ?>
                         ...
                         <div class="mt-2 max-h-96 md:max-h-50v relative overflow-x-hidden overflow-y-auto soft-scrollbar shadow-md sm:rounded-lg">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $marcasAssociadasAoUsuario; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $associadas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <td class="w-4 p-4">
                                            <div class="flex items-center">
                                        ...
                                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <?php echo e(str_pad($associadas->referencia, 4, '0', STR_PAD_LEFT)); ?>
                                        ...
                                        <td class="flex items-center px-6 py-4">                       
                                            <a wire:click="removeMarcaUser(<?php echo e($associadas->id); ?>)" wire:key="<?php echo e($associadas->id); ?>" class="font-medium text-red-600 dark:text-red-400 hover:underline ms-3 cursor-pointer">Remover</a>
                                        </td>
                                    </tr>
...
<?php /**PATH /home/u637911780/domains/printview.shop/resources/views/livewire/users/liberar-marca.blade.php ENDPATH**/ ?>