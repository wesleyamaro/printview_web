    ...
    <div class="flex items-center justify-between bg-green-700  rounded-lg mb-3">
     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="flex gap-x-2 font-semibold text-xl text-orange-600 dark:text-orange-500 leading-tight">
            ...
            <?php echo e(__('Cadastrar termopatch')); ?>
        ...
        <div x-data="{ tab: 'first' }">
            ...
            <div class="bg-gray-200 dark:bg-slate-800 p-2 rounded-b-lg">
                <div x-show="tab === 'first'" >
                    <div class="mt-2">
                        <?php echo $__env->make('components.termopatch.create-termopatch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            
                <div x-show="tab === 'second'">
                    <div class="mt-2">
                        <?php echo $__env->make('components.termopatch.consultar-termopatch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
...
<?php /**PATH /home/u637911780/domains/printview.shop/resources/views/livewire/cadastros/create-termopatch.blade.php ENDPATH**/ ?>