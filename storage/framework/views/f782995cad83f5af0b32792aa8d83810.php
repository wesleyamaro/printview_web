<div>
    <div x-data="{
    ...
    }" @scroll.window="handleScroll()" class="p-1 md:p-5  ">



        <!-- Header inicio -->
        <div  class="fixed top-16 left-0 w-full  md:px-5 z-10">
        ...
        <div
            class="w-full mt-36 md:mt-28    mx-auto   lg:px-3 lg:py-2 bg-gray-300 dark:bg-slate-800  rounded-lg">




            <div wire:poll.30s
                class="overflow-y-auto overflow-x-auto  w-full soft-scrollbar rounded-lg ">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $pedidoList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pedido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr wire:key="<?php echo e($pedido->id); ?>"
                                ...
                                <td class="px-3 hidden md:table-cell">
                                    ...
                                    <div class="<?php echo e($pedido->aplicativo ? '' : 'hidden'); ?>">
                                ...
                                <td class="px-3 py-2 cursor-pointer text-center"
                                    ...
                                    <h1 class="font-bold text-green-600 dark:text-green-400">
                                        <?php echo e($pedido->pedido_modelo); ?>
                                ...
                                <td wire:click="modalShow(<?php echo e($pedido->id); ?>)" class="px-3 py-2">
                                    <div
                                        class="flex items-center justify-center uppercase  text-gray-600 dark:text-lime-300">
                                        <!--[if BLOCK]><![endif]--><?php if(empty($pedido->prefeitura) && $pedido->grupo == '---'): ?>
                                            <span class="text-xs md:text-base text-blue-600 dark:text-blue-500">TERMOPATCH</span>
                                        <?php elseif($pedido->prefeitura): ?>
                                            <span class="text-xs md:text-base text-red-600 dark:text-red-500"><?php echo e($pedido->prefeitura); ?></span>
                                        <?php elseif($pedido->grupo): ?>
                                            <?php echo e($pedido->grupo); ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ENTREGAR-PEDIDO', $permissao)): ?>
                                    <td class="px-2 py-2 text-center">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <a wire:click="showEntregarPedido(<?php echo e($pedido->id); ?>)"
...
<?php endif; ?>
                                        ...
                                        <button class="text-white bg-indigo-700 px-2 py-1 rounded-md hover:bg-indigo-800"
                                            wire:click="generatePdf(<?php echo e($idpedido); ?>)" wire:loading.attr="disabled">
...
<?php /**PATH /home/u637911780/domains/printview.shop/resources/views/livewire/pedidos/pedido-table.blade.php ENDPATH**/ ?>