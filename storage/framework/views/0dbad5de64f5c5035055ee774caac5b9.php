      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
            <a href="<?php echo e(route('mais_vendido')); ?>" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="ms-3">Estampas mais vendidas</span>
            </a>
         </li>
         <?php endif; ?>
         ...
         <li>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  ...
                  <li>
                     <a href="<?php echo e(route('produto_transfer')); ?>" wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Transfers</a>
                  </li>
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('SUBMENU-TERMOPATCH', $permissao)): ?>
                  <li>
                     <a href="<?php echo e(route('produto_termopatch')); ?>" wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Termopatch</a>
                  </li>
                  <?php endif; ?>
...
</div><?php /**PATH C:\laragon\www\PrintView2\resources\views/components/sidebar-menu.blade.php ENDPATH**/ ?>