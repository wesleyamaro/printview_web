  ...
  <div class="col-span-full">
    ...
    <div class="flex flex-col space-y-1 mb-3">
      ...
      <div class="md:flex items-center gap-x-2 flex-column max-h-55v overflow-y-auto overflow-x-auto soft-scrollbar  flex-wrap md:flex-row space-y-4 md:space-y-0  p-2 bg-white dark:bg-slate-900 rounded-lg">
...
<!--Div info fim --><?php /**PATH C:\laragon\www\PrintView2\resources\views/components/pedidos/md/editor/correiaPedidoMD.blade.php ENDPATH**/ ?>