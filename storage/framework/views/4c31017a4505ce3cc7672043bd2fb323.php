<div>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="flex gap-x-2 font-semibold text-xl text-orange-600 dark:text-orange-500 leading-tight">
            ...
            <?php echo e(__('Filtros para produtos')); ?>
...
<?php $component = WireUi\View\Components\Input::resolve(['icon' => 'adjustments','label' => 'Filtro'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'filtro','placeholder' => 'Qual será o nome do filtro?','maxlength' => '30','class' => 'uppercase']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['positive' => true,'class' => 'h-9','type' => 'submit']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53cf851b4d6af185b0b5e0467ca69b92)): ?>
<?php $attributes = $__attributesOriginal53cf851b4d6af185b0b5e0467ca69b92; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'search','placeholder' => 'pesquise o filtro...']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf2cba1c7f87bbadef8ee9a6866b4816e)): ?>
<?php $attributes = $__attributesOriginalf2cba1c7f87bbadef8ee9a6866b4816e; ?>
...
<?php endif; ?>
                        ...
                        <div class="mt-2 max-h-96 md:max-h-50v relative overflow-x-hidden overflow-y-auto soft-scrollbar shadow-md sm:rounded-lg">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $filtroList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filtros): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">                                          
                                            <td class="w-4 p-4">
                                                <div class="flex items-center">
                                                    <input wire:model.live="checkboxDisponivel" value="<?php echo e($filtros->id); ?>"  wire:key="<?php echo e($filtros->id); ?>" id="checkbox-table-search-1" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                    <label for="checkbox-table-search-1" class="sr-only">checkbox</label>
                                                </div>
                                            </td>
                                            <td scope="row" class="hidden lg:table-cell px-0 py-4 text-gray-900 whitespace-nowrap dark:text-gray-400">
                                                <?php echo e('#'.$filtros->id); ?>

                                            </td>
                                            <th scope="row" class="px-0 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <?php echo e($filtros->filtro); ?>

                                            </th>
                                            <td class="flex items-center px-0 py-4">
                                                <a wire:click="editFiltro(<?php echo e($filtros->id); ?>)"  wire:key="<?php echo e($filtros->id); ?>" class="font-medium text-blue-600 dark:text-blue-400 hover:underline ms-3 cursor-pointer">Editar</a>                       
                                                <a wire:click="confirmSimple(<?php echo e($filtros->id); ?>)"  wire:key="<?php echo e($filtros->id); ?>" class="font-medium text-red-600 dark:text-red-400 hover:underline ms-3 cursor-pointer">Remover</a>
                                            </td>
                                        </tr>
...
<?php /**PATH /home/u637911780/domains/printview.shop/resources/views/livewire/cadastros/filtros.blade.php ENDPATH**/ ?>