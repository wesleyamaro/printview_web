...
<?php foreach($attributes->onlyProps(['class','xCloak','xShow','xOn:click']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'wireui::components.icons.outline.x','data' => ['class' => $class,'xCloak' => $xCloak,'xShow' => $xShow,'xOn:click' => $xOnClick]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH /home/u637911780/domains/printview.shop/storage/framework/views/4fc29d48c8f5c1d50054fd0b00e5a59c.blade.php ENDPATH**/ ?>