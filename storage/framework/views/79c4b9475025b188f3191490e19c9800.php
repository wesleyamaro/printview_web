...
<div class="<?php if($disabled): ?> opacity-60 <?php endif; ?>">
    <!--[if BLOCK]><![endif]--><?php if($label || $cornerHint): ?>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($cornerHint): ?>
                <?php if (isset($component)) { $__componentOriginal511d4862ff04963c3c16115c05a86a9d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal511d4862ff04963c3c16115c05a86a9d = $attributes; } ?>
<?php $component = Illuminate\View\DynamicComponent::resolve(['component' => WireUi::component('label')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('dynamic-component'); ?>
...
<?php endif; ?>
    ...
    <div class="relative rounded-md <?php if (! ($shadowless)): ?> shadow-sm <?php endif; ?>">
        <!--[if BLOCK]><![endif]--><?php if($prefix || $icon): ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($suffix || $rightIcon || ($hasError && !$append) || $spinner): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => $rightIcon,'class' => 'w-5 h-5','wire:loading.remove' => (bool) $spinner]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal511d4862ff04963c3c16115c05a86a9d)): ?>
<?php $attributes = $__attributesOriginal511d4862ff04963c3c16115c05a86a9d; ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if(!$hasError && $hint): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($name && !$errorless): ?>
        <?php if (isset($component)) { $__componentOriginal511d4862ff04963c3c16115c05a86a9d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal511d4862ff04963c3c16115c05a86a9d = $attributes; } ?>
...
<?php /**PATH /home/u637911780/domains/printview.shop/vendor/wireui/wireui/src/Providers/../../resources/views/components/input.blade.php ENDPATH**/ ?>