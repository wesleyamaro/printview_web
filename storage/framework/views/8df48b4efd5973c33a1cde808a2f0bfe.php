...
<div x-data="{ openModal: false, imgModal: '', referenciaModal: '' }" class="grid grid-cols-12 gap-1  w-full border-4 md:border-8 border-slate-900 bg-slate-400 dark:bg-slate-900   rounded-md p-1">
    ...
    <div class="col-span-4 w-auto bg-gray-50  rounded-md border-8 border-gray-100 dark:border-slate-700 shadow-md">
        ...
        class="w-24 min-h-28 max-h-28 rounded-md mx-auto cursor-pointer" src="<?php echo e($item->imagem_cliente ? url("storage/produtos/imagens_pedidos/{$item->imagem_cliente}") : url("storage/{$item->produtos->imagem}")); ?> " alt="transfer">  
...
</div><?php /**PATH /home/u637911780/domains/printview.shop/resources/views/components/pedidos/sm/cliente/itensPedidoSM.blade.php ENDPATH**/ ?>