...
<div x-data="{ openModal: false, imgModal: '', referenciaModal: '' }" class="flex flex-wrap  gap-2 w-full border-4 md:border-8 border-gray-300 dark:border-slate-900 bg-white dark:bg-slate-900  max-h-96 soft-scrollbar overflow-y-auto rounded-md p-1">
    ...
    <div class=" w-auto bg-gray-50  rounded-md border-8 border-gray-100 dark:border-slate-700 shadow-md">
        
        <div class="w-24 min-h-28 max-h-28 rounded-md">
            <img
            ...
            class="w-24 min-h-28 max-h-28 mx-auto cursor-pointer" src="<?php echo e($item->imagem_cliente ? url("storage/produtos/imagens_pedidos/{$item->imagem_cliente}") : url("storage/{$item->produtos->imagem}")); ?> " alt="transfer">  
        </div>
...
</div><?php /**PATH /home/u637911780/domains/printview.shop/resources/views/components/pedidos/md/cliente/itensPedidoMD.blade.php ENDPATH**/ ?>