...
<?php foreach($attributes->onlyProps(['shadowless','rightIcon']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['shadowless','rightIcon']); ?>
<?php foreach (array_filter((['shadowless','rightIcon']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php $component = WireUi\View\Components\Input::resolve(['shadowless' => $shadowless,'rightIcon' => $rightIcon] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH /home/u637911780/domains/printview.shop/storage/framework/views/f696fa21b98fc73ed635bf6926c15061.blade.php ENDPATH**/ ?>