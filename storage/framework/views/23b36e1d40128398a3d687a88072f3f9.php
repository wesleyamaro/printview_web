                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                      ...
                      <td class="px-3 py-2">
                        <div class="capitalize flex items-center justify-center">
                            ...
                            <?php echo e(isset($itenspedidoList[0]->medida) && $itenspedidoList[0]->medida ? $item->medida : $item->correiacor); ?>
...
<!--Div info fim --><?php /**PATH /home/u637911780/domains/printview.shop/resources/views/components/pedidos/sm/cliente/correiaPedidoSM.blade.php ENDPATH**/ ?>