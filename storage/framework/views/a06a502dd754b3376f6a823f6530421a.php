  ...
  <div class="col-span-full">
    ...
    <div class="flex flex-col space-y-3 mb-3">
        ...
        <div class="flex justify-between w-full border-2 border-dotted border-slate-300 dark:border-slate-600 rounded-md p-2" >
        ...
        <div class="flex gap-x-2 items-center justify-between w-full border-2 border-dotted border-slate-300 dark:border-slate-600 rounded-md p-2" >
...
<?php endif; ?> 
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('EDIT-STATUS-PEDIDO', $permissao)): ?>
                <div class="flex items-end gap-x-2 w-80">
...
<?php $component = WireUi\View\Components\Select::resolve(['clearable' => 'false','label' => 'Altere o status do  pedido','placeholder' => 'Selecione o status','options' => ['Aberto','cadastrado', 'Cancelado']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['autocomplete' => 'off','wire:model' => 'statuspedido','class' => 'text-blue-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="flex gap-x-2 border-2 border-dotted border-slate-300 dark:border-slate-600 rounded-md p-2">
...
<!--Div info fim --><?php /**PATH C:\laragon\www\PrintView2\resources\views/components/pedidos/md/editor/complementoPedidoMD.blade.php ENDPATH**/ ?>