        ...
        <div x-show="tab === 'first'" >
            <div class="mt-2 min-h-65v max-h-65v soft-scrollbar overflow-y-auto">
                 ...
                 <div>
                    ...
                    <div>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('EDIT-PEDIDO', $permissao)): ?>
                            <?php echo $__env->make('components.pedidos.md.editor.itensPedidoMD', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- EDITOR -->
                        <?php else: ?>
                            <?php echo $__env->make('components.pedidos.md.cliente.itensPedidoMD', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- CLIENTE -->
                        <?php endif; ?>
                    </div>
                    <!-- itens pedido fim -->
...
<?php /**PATH C:\laragon\www\PrintView2\resources\views/components/pedidos/md/pedido_md.blade.php ENDPATH**/ ?>