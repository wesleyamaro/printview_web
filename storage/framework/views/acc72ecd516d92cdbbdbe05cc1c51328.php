        ...
        <div x-show="tab === 'first'" >
            <div class="mt-2 min-h-65v max-h-65v soft-scrollbar overflow-y-auto">
                 ...
                 <div>
                    ...
                    <?php else: ?>
                        <?php echo $__env->make('components.pedidos.sm.cliente.itensPedidoSM2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- CLIENTE -->
                    <?php endif; ?>
                </div>
                <!-- itens pedido fim -->
...
</div><?php /**PATH /home/u637911780/domains/printview.shop/resources/views/components/pedidos/sm/pedido_sm.blade.php ENDPATH**/ ?>