...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'search_genero']); ?>
...
<?php endif; ?>
                    ...
                    <div class="w-52">
                        <?php if (isset($component)) { $__componentOriginalba37bc18e15fb5b3998ec0574c6b817c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalba37bc18e15fb5b3998ec0574c6b817c = $attributes; } ?>
<?php $component = WireUi\View\Components\Select::resolve(['placeholder' => 'Selecione o produto...'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(WireUi\View\Components\Select::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'search_produto']); ?>
                            <?php if (isset($component)) { $__componentOriginal2ca7cb6f73abe68c14d582be1a7a5ad6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2ca7cb6f73abe68c14d582be1a7a5ad6 = $attributes; } ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginal2ca7cb6f73abe68c14d582be1a7a5ad6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2ca7cb6f73abe68c14d582be1a7a5ad6 = $attributes; } ?>
<?php $component = WireUi\View\Components\Select\Option::resolve(['label' => 'APAGAR','value' => 'transfers'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('select.option'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(WireUi\View\Components\Select\Option::class))->getConstructor()): ?>
...
<?php endif; ?>
            ...
            <div class="md:w-96 text-right">
                <h1 class="text-gray-600 dark:text-gray-300">Total de estampas: <span class="dark:text-green-400">
                        <?php echo e($allTransfer->count()); ?> </span> </h1>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $transfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transfer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr
                            ...
                            <td class="uppercase text-center"><?php echo e('#' . $transfer->id); ?></td>
                            <td class="text-center">
                                <img 
                                @click="openModal = true; 
                                imgModal = '<?php echo e(url("storage/{$transfer->imagem}")); ?>'; 
                                filtros = '<?php echo e($transfer->filtros); ?>'";
                                    class="cursor-pointer p-1 rounded-lg min-h-20 max-h-20"
                                    src="<?php echo e(url("storage/{$transfer->imagem}")); ?>" alt="imagem do produto" />
                            </td>
                            <td class="uppercase text-center"><?php echo e($transfer->referencia); ?></td>
                             <td class="uppercase text-center <?php echo e($transfer->tipo == 'termopatch' ? 'text-blue-600' : ''); ?>"><?php echo e($transfer->tipo); ?></td>
                             <td class="uppercase text-center"><?php echo e($transfer->medida ?? '-'); ?></td>
                            <td class="uppercase text-center"><?php echo e($transfer->genero); ?></td>
                            <td class="uppercase text-center">
                                <?php echo e($transfer->marca->referencia . ' / ' . $transfer->marca->descricao); ?></td>
                            <td class="uppercase text-center"><?php echo e($transfer->filtros); ?></td>
                            <td class="uppercase text-center"><?php echo e($transfer->user->name); ?></td>
                            <td class="uppercase text-center"><?php echo e($transfer->created_at->format('d/m/Y H:i')); ?></td>
                            <td class="text-center">
                                <div class="flex justify-center items-center gap-x-5">

                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('EDIT-TRANSFER', $permissao)): ?>
                                        <a class="text-red-600 cursor-pointer"
                                            wire:click="editTransfer(<?php echo e($transfer->id); ?>)">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('DEL-TRANSFER', $permissao)): ?>
                                        <a class="text-red-600 cursor-pointer"
                                            wire:click="confirmDeleteTransfer(<?php echo e($transfer->id); ?>)">
    ...
    <div class="flex justify-between mt-2 ">
        ...
        <!--[if BLOCK]><![endif]--><?php if($transfers->hasMorePages()): ?>
        ...
        <h1 class="font-bold dark:text-gray-400">Total de registros: <span
                class="dark:text-green-400"><?php echo e($transfers->count()); ?></span></h1>
    </div>
     ...
     <!--[if BLOCK]><![endif]--><?php if($editTransferModal): ?>
        <?php echo $__env->make('components.cadastros.transfers.editTransferModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->


</div><?php /**PATH /home/u637911780/domains/printview.shop/resources/views/components/cadastros/transfers.blade.php ENDPATH**/ ?>