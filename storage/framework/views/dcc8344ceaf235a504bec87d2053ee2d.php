...
<?php $component = WireUi\View\Components\Input::resolve(['icon' => 'at-symbol','label' => ''.e(__('Email')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'seu email','id' => 'email','name' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('email')),'required' => true,'autofocus' => true,'autocomplete' => 'username']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if (isset($attributes)) { $__attributesOriginal0492513cc0d3c214a5ed582317f74f12 = $attributes; } ?>
<?php $component = WireUi\View\Components\Inputs\PasswordInput::resolve(['label' => ''.e(__('Password')).'','icon' => 'finger-print'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'sua senha','id' => 'password','name' => 'password','required' => true,'value' => '','autocomplete' => 'current-password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal0492513cc0d3c214a5ed582317f74f12)): ?>
<?php $attributes = $__attributesOriginal0492513cc0d3c214a5ed582317f74f12; ?>
<?php unset($__attributesOriginal0492513cc0d3c214a5ed582317f74f12); ?>
<?php endif; ?>
...
<?php $component = WireUi\View\Components\Button::resolve(['label' => ''.e(__('Log in')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['positive' => true,'class' => 'w-full mt-4','type' => 'submit']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\printview_web\resources\views/auth/login.blade.php ENDPATH**/ ?>