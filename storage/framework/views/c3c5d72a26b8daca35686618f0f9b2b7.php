              ...
              <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  <thead
                      ...
                      <tr>
                          ...
                          <th scope="col" class="px-3 py-3 ">
                            <?php echo e(isset($itenspedidoList[0]->medida) && $itenspedidoList[0]->medida ? 'Medidas' : 'Cor Correia'); ?>  
                          </th>
                          ...
                          <tr
                              ...
                              <td class="px-3 py-2">
                                  ...
                                  <div class="w-64 md:w-full">
                                      <input wire:model="correiacor.<?php echo e($item->produto->id); ?>"
                                          wire:key="<?php echo e($item->produto->id); ?>" type="text" id="small-input"
  ...
  <!--Div info fim -->
<?php /**PATH /home/u637911780/domains/printview.shop/resources/views/components/pedidos/md/editor/correiaPedidoMD.blade.php ENDPATH**/ ?>